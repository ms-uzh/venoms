...
const checks = [
  ...
  { path: "/search?family=Agelenidae", status: 200, includes: "family: Agelenidae" },
  { path: "/search?species=Eratigena%20agrestis", status: 200, includes: "species: Eratigena agrestis" },
  { path: "/search?formula=C17H39N7O", status: 200, includes: "Prop3334Gu" },
  { path: "/search?level=S-3", status: 200, includes: "level: S-3" },
  { path: "/search?confidence=C-1", status: 200, includes: "confidence: C-1" },
